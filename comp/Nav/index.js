      ...
      >
...

        {
          list.map(l => (
            ...
            >
              <div className='df text-3xl sm:text-[33px] md:text-[10px] lg:text-sm xl:text-lg font-medium md:font-semibold cursor-pointer md:py-1'>
                {l.title}
                <Arrow
        ...
        <button
          className="block w-full h-[61px] max-w-[360px] sm:max-w-[440px] md:h-auto mt-4 md:mt-0 py-2 md:py-0.5 md:px-3 mx-auto text-3xl md:text-lg lg:text-sm xl:text-lg font-medium md:font-semibold xl:font-bold text-[#222531] bg-primary-900 md:bg-white rounded md:rounded-sm"
