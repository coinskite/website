  ...
  return (
    <div className="dfc home-header-bg jcc gap-2.5 md:gap-8 pad-main-1-3 h-[40vh] sm:h-[60vh] md:h-[80vh] relative bg-cover">
      ...
      <p className="df gap-4">
        <button className="w-16 h-[18px] lg:w-44 lg:h-12 text-[7px] lg:text-2xl font-semibold text-[#17171F] bg-white rounded-[3px]">
          Services
        </button>
        <button className="w-16 h-[18px] lg:w-44 lg:h-12 text-[7px] lg:text-2xl font-semibold text-[#17171F] bg-primary-900 rounded-[3px]">
          Contact Us
        </button>
      </p>
