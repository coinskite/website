  ...
  return (
    <div className="pad-main-1-3 relative">
      <div className="max-w-7xl mx-auto">
        <div>
          <h1 className="text-[14px] xs:text-lg sm:text-[22px] md:text-[28px] lg:text-[38px] xl:text-[50px] font-bold">
            Join forces with Coinskite <br />
            and propel your business forward
          </h1>

          <p className="text-[6px] xs:text-[8px] sm:text-[10px] md:text-[14px] lg:text-lg xl:text-2xl font-medium my-4">
