function Header1() {
  return (
    <div className='dfc lg:gap-4 theme-sec pad-main-3 text-[#223764] text-center'>
      ...
      <button className="mx-auto mt-2 lg:mt-4 px-4 py-1 lg:px-6 lg:py-1.5 xl:py-2 xl:px-8 text-[8px] xs:text-xs sm:text-[15px] md:text-lg lg:text-[25px] xl:text-[28px] font-semibold bg-white rounded-[3px]">
        View-Openings
      </button>
    </div>
  )
